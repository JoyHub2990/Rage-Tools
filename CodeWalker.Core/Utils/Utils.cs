...
namespace CodeWalker
{
    ...
    {
        //Assembly.Location is empty in a single-file publish, which would make this null and blow
        //up every Path.Combine below - AppContext.BaseDirectory is correct in both layouts.
